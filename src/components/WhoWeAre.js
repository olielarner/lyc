...
const Row = ({ copy, flex, image }) => {
    ...
    return (
        <div
            ref={team}
            className={`team-row flex flex-${flex} container mx-auto py-14`}
        >
            <div
                className={`team-row-copy w-1/2 relative top-0 flex justify-center items-center`}
            >
                <p className=" font-unbounded text-4xl text-lyc-purple text-center w-2/3">
                    {copy}
                </p>
            </div>
            <div className="w-1/2">
                <div
                    className="team-row-image relative bottom-0 w-[0%] h-[500px] bg-cover"
...
const WhoWeAre = () => {
    ...
    return (
        <div className="the-team relative w-full bg-white pt-20 pb-60">
