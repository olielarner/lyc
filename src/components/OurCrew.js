...
const Member = () => {
    ...
    return (
        <div ref={person} className="w-1/3 relative cursor-crosshair">
            <div className="yellow-border w-11/12 absolute -top-[0px] -left-[0px] border-t-[20px] h-full border-l-[20px] border-r-[20px] border-b-[80px] border-lyc-yellow"></div>
            <div className="w-11/12 relative top-0 left-0 border-t-[20px] border-l-[20px] border-r-[20px] border-b-[80px] border-lyc-pink">
...
const OurCrew = () => {
    return (
        <div className="our-crew bg-lyc-purple py-40">
            <div className="container mx-auto flex">
                <div className="w-full mb-28">
                    <h2 className=" font-unbounded font-normal text-6xl text-white">
                        Our Crew
                    </h2>
                </div>
            </div>
