...
const Work = ({ image, cat, title, url }) => {
    ...
    return (
        <div className="w-full lg:w-[48%] p-8 single-work skewElem h-[500px] lg:h-[700px] top-0 relative">
            ...
            <div className="relative h-full">
                ...
                <h2 className="absolute bottom-0 font-unbounded text-lyc-purple py-3 px-6 bg-white border-x-8 border-y-8 border-lyc-yellow text-2xl lg:text-4xl">
                    {title}
                </h2>
            </div>
        </div>
...
const OurWork = () => {
    ...
    return (
        <div className="our-work py-20 lg:py-40">
            <div className="container mx-auto flex">
                <div className="w-full mb-12 lg:mb-20">
                    <h2 className=" font-unbounded font-normal text-center mb-0 lg:mb-16 text-5xl lg:text-9xl text-lyc-pink">
                        Our Work
                    </h2>
                </div>
            </div>
            <div
                ref={work}
                className="container mx-auto flex flex-col lg:flex-row flex-wrap gap-y-[60px] justify-between relative"
            >
